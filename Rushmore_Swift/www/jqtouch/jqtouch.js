    ...
    $.jQTouch = function(options) {
        ...
        function liveTap(e){
            ...
            if (tapReady == false || !$el.length) {
            	...
            	//	alert('problem!!');
            	//}
                console.warn('Not able to tap element.'+tapReady+" "+$el.length+" "+$el.attr('nodeName')+$el.attr('href')+"|"+hash+"|"+target)
                return false;
            }
        ...
        function updateOrientation() {
        	...
        	//}
        	//setDiv('HOLY ROTATING SCREENS BATMAN:' + orientation+" "+window.innerHeight);
...
//added by landon
function resetResetCounter(){}//overwrite in other js files