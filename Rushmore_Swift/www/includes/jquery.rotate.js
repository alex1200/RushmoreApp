...
Wilq32.PhotoEffect.prototype={
	...
	_Loader:(function()
	{
		...
		return function ()
		{
			...
			//Landon added this, we need these offsets in the click detection                                                                                                                          
            this._canvas.setAttribute('xoffset',Math.round(this._widthAddHalf));
            this._canvas.setAttribute('yoffset',Math.round(this._heightAddHalf));
            this._canvas.setAttribute('radius',Math.round(_widthMax));//this is the max width and height of the canvas                                                                                 
